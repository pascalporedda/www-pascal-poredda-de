...
function Privacy() {
  const darkSide = (
    <div className={'privacy-notice formatted-text'}>
      ...
      <ul>
        ...
        <li>
          ...
          this Agreement) refers to Pascal Poredda.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Pascal Poredda, accessible from{' '}
          <Link passHref href={'/'}>
            <a rel='noreferrer' target='_blank'>
              https://www.pascal-poredda.de
            </a>
          </Link>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <Link href={'/contact'} passHref>
            <a target='_blank'>https://pascal-poredda.de/contact</a>
          </Link>
        </li>
      </ul>
    </div>
  ...
  const lightSide = (
    <div className={'flex flex-col lg:justify-center lg:h-full'}>
      ...
      <p>
        Here you&apos;ll find all the information regarding your Privacy. On
        this page we describe all the tools, services, and requirements that are
        required for visiting this website.
      </p>
    </div>
  );
...
Privacy.getLayout = withPortfolioLayout;
